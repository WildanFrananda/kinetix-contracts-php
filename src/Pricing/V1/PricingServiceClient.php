...
class PricingServiceClient extends \Grpc\BaseStub {
    ...
    /**
     * @param \Pricing\V1\QuoteShippingRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function QuoteShipping(\Pricing\V1\QuoteShippingRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/pricing.v1.PricingService/QuoteShipping',
        $argument,
        ['\Pricing\V1\QuoteShippingResponse', 'decode'],
        $metadata, $options);
    }
