...
class IdentityServiceClient extends \Grpc\BaseStub {
    ...
    /**
     * @param \Identity\V1\MerchantsChangedSinceRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function MerchantsChangedSince(\Identity\V1\MerchantsChangedSinceRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/identity.v1.IdentityService/MerchantsChangedSince',
        $argument,
        ['\Identity\V1\MerchantsChangedSinceResponse', 'decode'],
        $metadata, $options);
    }
