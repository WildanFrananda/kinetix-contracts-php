...
class BinStockServiceClient extends \Grpc\BaseStub {
    ...
    /**
     * @param \Fulfillment\V1\CheckBinStockBatchRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function CheckBinStockBatch(\Fulfillment\V1\CheckBinStockBatchRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/fulfillment.v1.BinStockService/CheckBinStockBatch',
        $argument,
        ['\Fulfillment\V1\CheckBinStockBatchResponse', 'decode'],
        $metadata, $options);
    }
