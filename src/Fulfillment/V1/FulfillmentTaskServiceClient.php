...
class FulfillmentTaskServiceClient extends \Grpc\BaseStub {
    ...
    /**
     * @param \Fulfillment\V1\RecordCourierAwbRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function RecordCourierAwb(\Fulfillment\V1\RecordCourierAwbRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/fulfillment.v1.FulfillmentTaskService/RecordCourierAwb',
        $argument,
        ['\Fulfillment\V1\RecordCourierAwbResponse', 'decode'],
        $metadata, $options);
    }
