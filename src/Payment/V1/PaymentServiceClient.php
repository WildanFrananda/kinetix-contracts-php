...
class PaymentServiceClient extends \Grpc\BaseStub {
    ...
    /**
     * @param \Payment\V1\SettleShippingFeeRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function SettleShippingFee(\Payment\V1\SettleShippingFeeRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/payment.v1.PaymentService/SettleShippingFee',
        $argument,
        ['\Payment\V1\EscrowHoldResponse', 'decode'],
        $metadata, $options);
    }
